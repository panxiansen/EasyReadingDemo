...
public class Pic_SheYing_Fragment extends Fragment implements PicDataCallBack{

    private String url = "http://image.baidu.com/data/imgs?col=摄影&tag=摄影&sort=0";
    private int page = 1;
    private LoadPicData mLoadPicData;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pic_sheying, null);
    ...
    private void initrefreshLayout(View view) {
        ...
        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.pic_sheying_refreshlayout);
    ...
    private void initView(View view) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.pic_sheying_recyclerview);
    ...
    private void sendPicUrl(String url, int page){
        ...
        mLoadPicData = new LoadPicData();
        mLoadPicData.loadData(Pic_SheYing_Fragment.this, url, page);
