...
public class Pic_MeiNv_Fragment extends Fragment implements PicDataCallBack{

    private String url = "http://image.baidu.com/data/imgs?col=美女&tag=美女&sort=0";
    private int page = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pic_meinv, null);
        initView(view);
        sendPicUrl(url, page);
    ...
    private void initrefreshLayout(View view) {
        ...
        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.pic_meinv_refreshlayout);
    ...
    private void initView(View view) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.pic_meinv_recyclerview);
    ...
    private void sendPicUrl(String url, int page){
        ...
        mLoadPicData.loadData(Pic_MeiNv_Fragment.this, url, page);
