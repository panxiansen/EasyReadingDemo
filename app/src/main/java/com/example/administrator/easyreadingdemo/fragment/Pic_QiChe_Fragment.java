...
public class Pic_QiChe_Fragment extends Fragment implements PicDataCallBack{

    private String url = "http://image.baidu.com/data/imgs?col=汽车&tag=汽车&sort=0";
    private int page = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pic_qiche, null);
    ...
    private void initrefreshLayout(View view) {
        ...
        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.pic_qiche_refreshlayout);
    ...
    private void initView(View view) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.pic_qiche_recyclerview);
    ...
    private void sendPicUrl(String url, int page){
        ...
        mLoadPic.loadData(Pic_QiChe_Fragment.this, url, page);
