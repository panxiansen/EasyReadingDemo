...
import com.example.administrator.easyreadingdemo.bean.News_News_Info;
...
public class News_AgricultureNews_Fragment extends Fragment implements NewsDataCallBack {

    private String url = "http://api.tianapi.com/startup/?key=16b9d58e1149ecb6500c1e648728b9a4&num=10";
    private int page = 1;

    private News_News_Info mInfo;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.news_agriculture_news, null);
    ...
    private void sendNewsUrl(String url, int page) {
        ...
        mLoadNewsData.loadData(News_AgricultureNews_Fragment.this, url, page);

    }

    private void initRefreshLayout(View view) {

        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.news_agriculture_news_refreshlayout);
        mRefreshLayout.setOnRefreshListener(new RefreshListenerAdapter() {
            ...
            public void onRefresh(TwinklingRefreshLayout refreshLayout) {
                ...
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getContext(), "已经刷新数据", Toast.LENGTH_SHORT).show();
    ...
    private void initView(View view){
        ...
        handler = new Handler();
        mRecyclerView = (RecyclerView) view.findViewById(R.id.news_agriculture_news_recyclerview);
