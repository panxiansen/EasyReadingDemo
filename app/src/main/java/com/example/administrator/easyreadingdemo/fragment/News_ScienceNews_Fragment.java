...
public class News_ScienceNews_Fragment extends Fragment implements NewsDataCallBack{

    private String url = "http://api.tianapi.com/keji/?key=16b9d58e1149ecb6500c1e648728b9a4&num=10";
    private int page = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.news_science_news, null);
    ...
    private void initRefreshLayout(View view) {
        ...
        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.news_science_news_refreshlayout);
    ...
    private void initView(View view){
        handler = new Handler();
        mRecyclerView = (RecyclerView) view.findViewById(R.id.news_science_news_recyclerview);
    ...
    private void sendNewsUrl(String url, int page) {
        ...
        mLoadNewsData.loadData(News_ScienceNews_Fragment.this, url ,page);
