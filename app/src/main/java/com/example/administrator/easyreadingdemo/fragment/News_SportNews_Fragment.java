...
public class News_SportNews_Fragment extends Fragment implements NewsDataCallBack{

    private String url = "https://api.tianapi.com/tiyu/?key=16b9d58e1149ecb6500c1e648728b9a4&num=10";
    private int page = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.news_sport_news, null);
    ...
    private void initView(View view){
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.news_sport_news_recyclerview);
    ...
    private void initSwipeRefreshLayout(View view){
        ...
        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.news_sport_news_refreshlayout);
    ...
    private void sendNewsUrl(String url, int page){
        ...
        mLoadNewsData = new LoadNewsData();
            mLoadNewsData.loadData(News_SportNews_Fragment.this, url, page);
