...
public class Pic_DongMan_Fragment extends Fragment implements PicDataCallBack{

    private String url = "http://image.baidu.com/data/imgs?col=动漫&tag=动漫&sort=0";
    private int page = 1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.pic_dnogman, null);
    ...
    private void sendPicUrl(String url, int page) {
        ...
        mLoadPic.loadData(Pic_DongMan_Fragment.this, url, page);

    }

    private void initView(View view) {

        mRecyclerView = (RecyclerView) view.findViewById(R.id.pic_dongman_recyclerview);
    ...
    private void initRefreshLayout(View view){
        ...
        mRefreshLayout = (TwinklingRefreshLayout) view.findViewById(R.id.pic_dnogman_refreshlayout);
